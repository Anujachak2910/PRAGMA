...
function ConfidenceBadge({ score }) {
  ...
  const cls = score >= 0.85
    ? 'bg-success-50 dark:bg-green-900/20 text-success-700 dark:text-green-400 border-success-200 dark:border-green-800/60'
    : score >= 0.65
    ? 'bg-warning-50 dark:bg-amber-900/20 text-warning-700 dark:text-amber-400 border-warning-200 dark:border-amber-800/60'
    : 'bg-danger-50 dark:bg-red-900/20 text-danger-700 dark:text-red-400 border-danger-200 dark:border-red-800/60'
  return (
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 dark:bg-black/60 backdrop-blur-sm animate-fadeIn">
      <div className="mx-4 w-full max-w-md rounded-2xl border border-line bg-white dark:bg-card p-6 shadow-xl">
        ...
        <h2 className={`text-center font-serif text-lg font-semibold ${
          isApprove ? 'text-success-700 dark:text-green-400' : 'text-danger-700 dark:text-red-400'
        }`}>
